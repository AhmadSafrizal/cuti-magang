				...
				<tbody>
					<tr>
						<td class="text-left" width="20%">
							<img src="libs/images/wrk-logo.png" alt="logo-dkm" width="70" />
						</td>
						<td class="text-center" width="60%">
						<b>PT. WIKA REKAYASA KONSTRUKSI</b> <br>
						Jl. Kodeco KM 3.5 Batulicin, Tanah Bumbu, Kalimantan Selatan 77711<br>
						Telp: (021) 89115030<br>
						<td class="text-right" width="20%">
							<img src="libs/images/wrk.png" alt="logo-dkm" width="130" height="70"/>
						</td>
					</tr>
				</tbody>
			</table>
