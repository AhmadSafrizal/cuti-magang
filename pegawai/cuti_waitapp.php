			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-body">
						<?php
						$Sql = "SELECT cuti.* FROM cuti WHERE cuti.npp='$id' AND cuti.stt_cuti ='Menunggu Approval Kasi' OR cuti.stt_cuti ='Menunggu Approval DMP' OR cuti.stt_cuti ='Menunggu Approval HRD' OR cuti.stt_cuti ='Menunggu Approval Pengganti' AND cuti.npp='$id' ORDER BY cuti.tgl_pengajuan DESC";
