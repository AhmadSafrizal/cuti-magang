...
$id = $sess_pegawaiid;
$sql_g = "SELECT employee.* FROM employee WHERE npp='$id'";
...
<head>
	...
	<title>WRK BATULICIN - <?php echo $pagedesc ?></title>
		...
		<nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
			<div class="navbar-header">
				...
				<a class="navbar-brand hidden-xs" href="index.php">
					<img src="../libs/images/wrk-logo.png" alt="brand" width="32" class="float-left image-brand">
					<div class="float-right">&nbsp;<strong>PT. WIKA REKAYASA KONSTRUKSI</strong></div>
			...
			<ul class="nav navbar-top-links navbar-right">
				<li class="dropdown dropdown-right">
					...
					<ul class="dropdown-menu dropdown-user">
						<li><a href="akun.php"><i class="fa fa-user fa-fw"></i>&nbsp;Pengaturan Akun</a></li>
						<li class="divider"></li>
						<li><a href="pengaturan.php"><i class="fa fa-gear fa-fw"></i>&nbsp;Ubah Password</a></li>
						<li class="divider"></li>
						<li><a href="ubah_foto.php"><i class="fa fa-photo fa-fw"></i>&nbsp;Ubah Foto</a></li>
						<li class="divider"></li>
						<li><a href="ubah_ttd.php"><i class="fa fa-photo fa-fw"></i>&nbsp;Ubah Tanda Tangan</a></li>
						<li class="divider"></li>
				...
				<div class="sidebar-nav navbar-collapse">
					<ul class="nav" id="side-menu">
						<li class="sidebar-search">
							<h4>Sistem Informasi Pengajuan Cuti Online <br> <b>PT. WIKA REKAYASA KONSTRUKSI</b></h4>
						...
						<ul class="nav nav-second-level">
							...
							if ($pagedesc == "Buat Pengajuan") {
								echo '<li><a href="cuti_create_proyek.php" class="active">Buat Pengajuan</a></li>';
							} else {
								echo '<li><a href="cuti_create_proyek.php">Buat Pengajuan</a></li>';
							}
