	...
	<div id="section-to-print">
		...
		<div><br />
			<table width="100%">
				...
				<tr>
					<?php
					// $peng = $result['pengganti'];
					$peng = "SELECT employee.* , cuti.* FROM employee, cuti WHERE employee.npp=cuti.pengganti";
					$query = mysqli_query($conn, $peng);
					$pengganti = mysqli_fetch_array($query);
					?>
					<td width="20%"><b>Pengganti</b></td>
					<td width="2%"><b>:</b></td>
					<td width="78%"><?php echo $pengganti['nama_emp']; ?></td>
				</tr>
				<tr>
					<td colspan="3">&nbsp;</td>
				</tr>
				<tr>
					<td width="20%"><b>Proyek</b></td>
					<td width="2%"><b>:</b></td>
					<td width="78%"><?php echo $pengganti['proyek']; ?></td>
				</tr>
				<tr>
					<td colspan="3">&nbsp;</td>
				</tr>
