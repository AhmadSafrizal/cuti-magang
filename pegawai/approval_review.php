						...
						<div class="panel-body">
							...
							<div class="form-group">
								...
								<div class="col-sm-4">
									<?php
									$proyek = $data['proyek'];
									$dmp = "SELECT employee.* FROM employee WHERE hak_akses='dmp' AND active='Aktif' AND proyek1='$proyek' OR proyek2='$proyek'";
									$d = mysqli_query($conn, $dmp);
									while ($dmpData = mysqli_fetch_array($d)) {
									?>
