...
if ($_GET) {
	$kode = $_GET['code'];
	$sql = "SELECT employee.* FROM employee WHERE npp='" . $_GET['code'] . "'";
	...
	<div id="section-to-print">
		...
		<div><br />
			<table width="100%">
				...
				<tr>
					<td width="20%"><b>Status Perkawinan</b></td>
					<td width="2%"><b>:</b></td>
					<td width="78%"><?php echo $result['status_nikah']; ?></td>
				</tr>
				<tr>
					<td colspan="3">&nbsp;</td>
				</tr>
				...
				<tr>
					<td width="20%"><b>Proyek 1</b></td>
					<td width="2%"><b>:</b></td>
					<td width="78%"><b><?php echo $result['proyek1']; ?></b></td>
				</tr>
				<tr>
					<td colspan="3">&nbsp;</td>
				</tr>
				<tr>
					<td width="20%"><b>Proyek 2</b></td>
					<td width="2%"><b>:</b></td>
					<td width="78%"><b><?php echo $result['proyek2']; ?></b></td>
				</tr>
				<tr>
					<td colspan="3">&nbsp;</td>
				</tr>
