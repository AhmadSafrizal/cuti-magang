						...
						<table class="table table-striped table-bordered table-hover" id="tabel-data">
							...
							<tbody>
								...
								while ($data = mysqli_fetch_array($Qry)) {
									...
									<?php
									$npp = $data['npp'];
									$h = mysqli_query($conn, "SELECT employee.hak_akses FROM employee WHERE employee.npp='$npp'");
									$hak = mysqli_fetch_array($h);
									if ($hak['hak_akses'] == "pegawai") {
									?>
										<a href="app_cetak.php?no=<?php echo $data['no_cuti']; ?>" target="_blank" class="btn btn-primary btn-xs">Cetak</a>
									<?php
									} else {
									?>
										<a href="cuti_cetak.php?no=<?php echo $data['no_cuti']; ?>" target="_blank" class="btn btn-primary btn-xs">Cetak</a>
								<?php
