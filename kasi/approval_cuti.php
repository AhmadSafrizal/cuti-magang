			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-body">
						<?php
						$Sql = "SELECT cuti.*, employee.* FROM cuti, employee WHERE cuti.npp=employee.npp AND cuti.kasi='$id' AND cuti.stt_cuti='Menunggu Approval Kasi' ORDER BY cuti.tgl_pengajuan DESC";
