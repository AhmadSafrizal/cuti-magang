            ...
            <div class="container-fluid">
				...
				<div class="row">
					<div class="col-lg-12">
						...
						<?php
								$Sql = "SELECT cuti.*, employee.* FROM cuti, employee WHERE cuti.npp=employee.npp AND cuti.stt_cuti ='Menunggu Approval DMP' OR cuti.stt_cuti ='Menunggu Approval MP' OR cuti.stt_cuti ='Menunggu Approval HRD' AND cuti.npp='$id' ORDER BY cuti.tgl_pengajuan DESC";
