...
$sqlb = "SELECT * FROM cuti WHERE npp='$id' AND stt_cuti ='Menunggu Approval Kasi' OR stt_cuti='Menunggu Approval DMP' OR stt_cuti='Menunggu Approval MP' OR stt_cuti='Menunggu Approval HRD'";
...
$sqld = "SELECT * FROM cuti WHERE kasi='$id' AND stt_cuti='Menunggu Approval Kasi'";
$ressd = mysqli_query($conn, $sqld);
$d = mysqli_num_rows($ressd);

$sqle = "SELECT * FROM cuti WHERE kasi='$id'";
