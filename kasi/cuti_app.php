			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-body">
						<?php
						$Sql = "SELECT cuti.*, employee.* FROM cuti, employee WHERE cuti.npp=employee.npp AND cuti.hrd_app='1' AND cuti.npp='$id' ORDER BY cuti.tgl_pengajuan DESC";
						...
						<table class="table table-striped table-bordered table-hover" id="tabel-data">
							...
							<tbody>
								...
								while ($data = mysqli_fetch_array($Qry)) {
									...
									<a href="cuti_cetak.php?no=<?php echo $data['no_cuti']; ?>" target="_blank" class="btn btn-warning btn-xs">Cetak</a></td>
								<?php
									echo '</td>';
									echo '</tr>';
									$i++;
