...
$ka = mysqli_query($conn, "SELECT employee.* FROM employee WHERE employee.npp='$b'");
$kasi = mysqli_fetch_array($ka);
				...
				<tbody>
					<tr>
						...
						<td class="text-left" width="5%">
							<p style="border:1px solid black;">&nbsp;LVL : <b>Staff <b></p>
						</td>
					</tr>
				</tbody>
			</table>
				...
				<table style="margin-left:40px;">
					<h4>
						<tbody>
							<tr>
								<td width="418px">
									<img src="../foto/ttd/<?php echo $pengganti['ttd'] ?>" alt="ttd" style="height: 40px;">
									<br>
									<u><?php echo $pengganti['nama_emp']; ?></u>
								</td>
								<td>
									<img src="../foto/ttd/<?php echo $result['ttd'] ?>" alt="ttd" style="height: 40px;">
									<br>
				...
				<table style="margin-left: 40px;">
					<h4>
						<tbody>
							<tr>
								<td width="230px">
									<img src="../foto/ttd/<?php echo $dmp['ttd'] ?>" alt="ttd" style="height: 40px">
									<br>
									<u><?php echo $dmp['nama_emp'] ?></u>
								</td>
								<td width="230px">
									<img src="../foto/ttd/<?php echo $kasi['ttd'] ?>" alt="ttd" style="height: 40px;">
									<br>
									<u><?php echo $kasi['nama_emp'] ?></u>
								</td>
								<td>
									<img src="../foto/ttd/<?php echo $hrd['ttd'] ?>" alt="ttd" style="height: 40px">
									<br>
