            ...
            <div class="container-fluid">
				...
				<div class="row">
					<div class="col-lg-12">
						...
						<?php
								$Sql = "SELECT cuti.*, employee.* FROM cuti, employee WHERE cuti.npp=employee.npp AND cuti.dmp='$id' AND cuti.stt_cuti='Menunggu Approval DMP' ORDER BY cuti.tgl_pengajuan DESC";
