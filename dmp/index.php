...
$sqlb = "SELECT * FROM cuti WHERE npp='$id' AND stt_cuti!='Menunggu Approval'";
...
$sqld = "SELECT * FROM cuti WHERE dmp='$id' AND stt_cuti='Menunggu Approval DMP'";
$ressd = mysqli_query($conn, $sqld);
$d = mysqli_num_rows($ressd);

$sqle = "SELECT * FROM cuti WHERE dmp='$id'";
